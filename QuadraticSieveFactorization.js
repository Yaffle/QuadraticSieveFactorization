 2, 0, 34, 13, 32, 12, 107, 108, 79, 32, 15, 32, 16, 32, 1, 32, 14, 106, 40, 2, 0, 34, 15, 32, 12, 107, 108, 79, 114, 65, 0, 65, 1, 32, 13, 32, 15, 27, 27, 4, 64, 32, 8, 65, 2, 116, 32, 14, 65, 2, 117, 34, 14, 54, 2, 0, 32, 8, 65, 1, 106, 65, 2, 116, 32, 9, 32, 6, 107, 65, 2, 117, 34, 16, 54, 2, 0, 32, 8, 65, 2, 106, 33, 8, 32, 13, 32, 15, 70, 4, 64, 32, 8, 65, 2, 116, 32, 14, 54, 2, 0, 32, 8, 65, 1, 106, 65, 2, 116, 32, 16, 54, 2, 0, 32, 8, 65, 2, 106, 33, 8, 11, 11, 32, 11, 13, 0, 11, 11, 32, 9, 65, 4, 106, 33, 9, 12, 1, 11, 11, 11, 32, 10, 65, 32, 106, 33, 10, 12, 1, 11, 11, 32, 8, 32, 5, 107, 11]);
...
function congruencesUsingQuadraticSieve(primes, N, sieveSize0) {
  ...
  export function findSmoothEntry(thresholdApproximation:i32, i:i32):i32 {
    ...
    while (!i8x16.bitmask(i8x16.ge_u(v128.load(i), t))) {
      i += 16;
    }
    return i;
  }
  export function updateWheelsInternalNext(wheelsCount:i32, alphav:i32, wheelSteps:i32, wheelRoots1:i32, wheelRoots2:i32, e:i32):void {
    for (let i = 0; i < (wheelsCount << 2); i += 16) {
      ...
      const p = v128.load(wheelSteps + i);
      let r1 = v128.load(wheelRoots1 + i);
      let r2 = v128.load(wheelRoots2 + i);
      a = i32x4.add(i32x4.sub(a, i32x4.splat(e)), v128.and(i32x4.eq(a, i32x4.splat(e)), p));
  ...
  @inline
  function load_low_bits(offset:i32):v128 {
    return i16x8.narrow_i32x4_u(v128.and(v128.load(offset, 0), i32x4.splat(0xFFFF)), v128.and(v128.load(offset, 16), i32x4.splat(0xFFFF)));
  }
  export function handleSmallWheels(wheelsCount:i32, wheelRoots1:i32, wheelRoots2:i32, divTestA:i32, divTestB:i32, storage:i32, smoothEntriesXStart:i32, smoothEntriesXEnd:i32):i32 {
    ...
    for (let j = 0; j < (wheelsCount << 2); j += 32) {
      const proot1 = load_low_bits(wheelRoots1 + j);
      const proot2 = load_low_bits(wheelRoots2 + j)
      const ta = load_low_bits(divTestA + j);
      const tb = load_low_bits(divTestB + j);
      let m = i32x4.splat(-1);
      ...
      if (i8x16.bitmask(i16x8.le_u(m, tb)) != 0) {
        for (let i = smoothEntriesXStart; i < smoothEntriesXEnd; i += 4) {
          ...
          if (bitmask != 0) {
            const e = i32.load(i);
            do {
              const v = i32.ctz(bitmask);
              const index = (v >> 1); // as we use i8x16 bitmask
              const j1 = j + (index << 2);
              bitmask ^= (3 << v); // 3 as we use i8x16 bitmask
